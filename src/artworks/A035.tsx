...
const Artwork = (props) => {
  ...
  const palette = ["#281A16", "#434F35", "#7C643C", "#623012", "#B96828", "#9D3E16", "#D78F37", "#A58E60", "#E0CA4E", "#D9C693"];
  ...
  function drawBezierVine(p5, xIn, yIn) {
    ...
    if (p5.random(1) < 0.5) {
      const x2 = p5.random(x - xAdj, nextX + xAdj);
      const y2 = p5.random(y - yAdj, nextY + yAdj);
      p5.line(x, y, x2, y2);
      p5.fill(palette[p5.int(p5.random(10))]);
      const sze = p5.random(5, 15);
